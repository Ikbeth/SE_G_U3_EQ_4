...
def estandarizacion():
    ...
    for line in inst:
        ...
        prom1 = prom1 + int(datos[0])
        prom2 = prom2 + int(datos[1])
        prom3 = prom3 + int(datos[2])
        prom4 = prom4 + int(datos[3])
        prom5 = prom5 + int(datos[4])
    ...
    #print("{}, {}, {}, {}, {}, {}".format(prom1, prom2, prom3, prom4, prom5))
    ...
    #print("{}, {}, {}, {}, {}, {}".format(desv1, desv2, desv3, desv4, desv5))
